angular.module('treehouseCourse', [])
  ...
  // set the controller to the user data
  .controller('userStepCtrl', function ($scope, User) {
    // pulls data from the User data
    $scope.user = User.get();
  })

  // connect the controller to the Survey factory (data)
  ...
  .factory('Survey', function () {
    ...
    return {
      ...
      getQuestion: function (id) {
        // loop through questions to only get the questions with the correct id
