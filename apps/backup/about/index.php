...
<section class="group" id="about">
  <ul>
    <li>
      <a>
        <figure class="tint">
          <img src="<?php echo BASE_URL; ?>img/about/ethan_neff_portrait_mini.jpg" alt="self portrait of ethan neff" id="profile-picture">
        </figure>
      </a>
      <div class="text-box">
    ...
    <li>
      <a href="<?php echo BASE_URL; ?>img/about/ethan_neff_resume.png" id="resume">
        <figure class="tint">
          <img src="<?php echo BASE_URL; ?>img/about/ethan_neff_resume.png" alt="resume of ethan neff">
        </figure>
      </a>
      <div class="text-box">
        <h3>Resume</h3>
    ...
    <li>
      <a href="//youtu.be/9biGjosW1NU">
        <figure class="tint">
          <img src="<?php echo BASE_URL; ?>img/about/secret_weapon_mini.gif" alt="snapshot of the iPhone app I am creating called The Secret Weapon">
        </figure>
      </a>
      <div class="text-box">
